...
/**
 * Classe pour les éléments (obstacles) qui vont être visités par les joueurs, et qui
 * , selon l'obstacle, vas donner à ceux-ci une bonification ou une pénalisation
